...
* Crafting adversarial examples (AXs) using Projected Gradient Descent (PGD)
* Purifying the AXs usign the respective hand-designed transformations (viz. VectorDefense, bit-depth reduction and image quilting)
